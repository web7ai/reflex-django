...
If your page is standard list, edit, save, and delete, use [`ModelState`](reactive_model_state.md) and skip this page until you feel the constraint.
...
**Next up:** [Forms and validation →](forms_and_validation.md)