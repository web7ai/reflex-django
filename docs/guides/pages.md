...
If your team prefers a separate `frontend/` package, point `REFLEX_DJANGO_PAGE_PACKAGES` at the modules you want. See [Project structure](../getting-started/project_structure.md).
