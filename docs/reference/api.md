...
| **Performance** | `REFLEX_DJANGO_EVENT_BRIDGE_MODE`, `resolve_bridge_tier`, `invalidate_event_cache` | [Scaling and performance](../operations/scaling.md) |
| **CLI** | `run_reflex`, `export_reflex`, `reflex django ...` | [CLI reference](../operations/cli.md) |
| **Settings** | All `REFLEX_DJANGO_*` keys | [Settings reference](settings.md) |
