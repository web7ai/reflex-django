...
- [ ] [The three knobs](../overview/concepts.md): I know settings, page imports, and catch-all are separate jobs.
- [ ] [Why reflex-django exists](../overview/concepts.md): I understand the HTTP vs WebSocket gap.
- [ ] [How Django works](../overview/concepts.md): optional; skipped or done.
- [ ] [How Reflex works](../overview/concepts.md): optional; skipped or done.
- [ ] [How they fit together](../overview/concepts.md): I can explain default dev (Vite + Reflex backend with Django mounted) and production routing.
- [ ] [Install](../getting-started/installation.md): reflex-django is in my project.
- [ ] [Your first app](../getting-started/quickstart.md): I ran `manage.py run_reflex` and saw a page update.
- [ ] [Configuration](../getting-started/configuration.md): I know where `REFLEX_DJANGO_*` settings live.

!!! tip "Brownfield projects"
    Already have Django or Reflex? After step 5, branch to [Existing Django project](../getting-started/existing_django_project.md) or [Existing Reflex project](../getting-started/existing_reflex_project.md) instead of the quickstart.

---

## After the path

Once the checklist is green, drop into build guides as you need them: [Pages in views.py](../guides/pages.md), [CRUD with ModelState](../guides/crud.md#modelstate), [Authentication](../guides/authentication.md), [Deployment](../operations/deployment.md), [Scaling and performance](../operations/scaling.md) for high-traffic or multi-worker setups.
...
**Next up:** [The three knobs](../overview/concepts.md)
