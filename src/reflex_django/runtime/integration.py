...
def _patch_state_dispatcher_template() -> None:
    ...
    try:
        ...
        logging.getLogger("reflex_django.runtime.integration").warning(
...
def _patch_compile_or_validate_app() -> None:
    ...
    _ORIGINAL_COMPILE_OR_VALIDATE = prerequisites.compile_or_validate_app
    ...
    def compile_or_validate_app(
        ...
        **kwargs: Any,
        ...
        result = _ORIGINAL_COMPILE_OR_VALIDATE(
            compile=compile,
