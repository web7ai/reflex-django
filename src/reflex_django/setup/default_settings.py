...
# When True, :class:`reflex_django.bridge.django_event.DjangoEventBridge` refreshes
...
# When True (default), :class:`reflex_django.bridge.django_event.DjangoEventBridge`
...
# ``--from-build`` on the command line, or env ``REFLEX_DJANGO_SERVE_FROM_BUILD=1``).
...
ROOT_URLCONF = os.environ.get("REFLEX_DJANGO_URLCONF", "reflex_django.django.urls")
