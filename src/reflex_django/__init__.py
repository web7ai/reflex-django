...
_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    ...
    "auser_in_group": ("reflex_django.auth.shortcuts", "auser_in_group"),
    ...
    "group_required": ("reflex_django.auth.decorators", "group_required"),
    "staff_required": ("reflex_django.auth.decorators", "staff_required"),
    "superuser_required": ("reflex_django.auth.decorators", "superuser_required"),
