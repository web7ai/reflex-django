...
These patches run from :meth:`reflex_django.plugin.ReflexDjangoPlugin.post_compile`,
:func:`apply_frontend_stability_after_compile` (after every compile in dev/export),
and from :func:`reflex_django.vite_proxy.patch_vite_config` (React dedupe only).
