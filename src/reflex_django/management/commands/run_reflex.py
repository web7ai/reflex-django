...
paths are served from the Reflex backend by default. Set ``RXDJANGO_PROXY_SERVER``
...
class Command(BaseCommand):
    ...
    help = (
        ...
        "Reflex backend). Set RXDJANGO_PROXY_SERVER only when Django runs "
    ...
    def add_arguments(self, parser: Any) -> None:
        ...
        parser.add_argument(
            ...
            dest="django_server",
            default=None,
            help="Override RXDJANGO_PROXY_SERVER for this run (e.g. http://127.0.0.1:8000).",
        )
        parser.add_argument(
            "--loglevel",
        ...
        parser.add_argument(
            ...
            action="store_true",
            dest="with_vite",
            help="Force the Vite HMR dev loop when REFLEX_DJANGO_SERVE_FROM_BUILD is set.",
        )
        parser.add_argument(
            "--skip-rebuild",
            action="store_true",
