"""ASGI dispatcher for :attr:`~reflex_django.setup.routing.UrlRoutingMode.REFLEX_OUTER`.

Reflex owns the public port; Django admin/API/static HTTP is proxied to a
separate Django HTTP worker (``reflex_django.asgi.http_entry``).
"""
...
logger = logging.getLogger("reflex_django.asgi.reflex_outer")
