...
from reflex_django.asgi.app import ASGIApp, ASGIMessage, ASGIReceive, ASGIScope, ASGISend

logger = logging.getLogger("reflex_django.asgi.http_proxy")
...
async def _get_client(upstream_base: str) -> Any:
    ...
    try:
        ...
        msg = (
            "reflex_django.asgi.http_proxy requires httpx. "
